...
export default function FAQSection({ onBookDemo }: FAQSectionProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Most academies are up and running in under 7 minutes. You can import your existing student data from Excel, or add them manually. Our setup wizard guides you through every step – courses, batches, instructors, and fee structures.'
    },
