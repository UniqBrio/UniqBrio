...
export function EventAnalytics({ events }: EventAnalyticsProps) {
  ...
  const statStyles = [
    ...
    { bg: "bg-gradient-to-br from-orange-50 to-orange-100", titleText: "text-orange-700", valueText: "text-orange-900" },
  ]
    ...
    <div className="w-full space-y-4">
      <div className="sticky top-0 z-20 bg-white pt-4 pb-4">
        ...
        {topStats.map((stat, index) => (
          <Card key={index} className={`${statStyles[index]?.bg} border shadow-sm`}>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className={`text-sm font-medium ${statStyles[index]?.titleText}`}>{stat.title}</p>
                  <p className={`text-2xl font-bold ${statStyles[index]?.valueText}`}>{stat.value}</p>
                  <p className={`text-xs ${statStyles[index]?.titleText} opacity-80`}>{stat.subtitle}</p>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="details" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-[#8A2BE2] text-base">
