...
export const AttendanceDrafts = forwardRef<AttendanceDraftsHandle, AttendanceDraftsProps>(function AttendanceDrafts(
  ...
  useImperativeHandle(ref, () => ({
    ...
    deleteDraft: async (id: number | string) => {
      try {
        const response = await fetch(`/api/dashboard/staff/instructor/attendance-drafts/${id}`, {
          method: 'DELETE',
          credentials: 'include'
        });
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            ...
            onClick={async () => {
              if (draftToDelete) {
                try {
                  const response = await fetch(`/api/dashboard/staff/instructor/attendance-drafts/${draftToDelete.id}`, {
                    method: 'DELETE',
                    credentials: 'include'
                  });
