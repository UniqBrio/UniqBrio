...
function AttendanceManagementInner() {
  ...
  return (
    ...
    <h1 className="text-3xl md:text-3xl font-bold text-purple-700">Instructor Attendance Management </h1>
        </div>
          ...
          <div className="p-2">
            ...
            {recordToDelete && (
              <div className="text-sm bg-gray-50 border rounded p-3">
                <div><span className="text-gray-500">Instructor:</span> <span className="font-medium">{recordToDelete.studentName} ({recordToDelete.studentId})</span></div>
