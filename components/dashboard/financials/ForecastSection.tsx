...
export function ForecastSection() {
  ...
  return (
    <section
      className={"bg-white border-2 border-gray-200 rounded-lg p-6 mb-10 shadow-sm"}
    ...
    >
      ...
      <div className={`flex flex-wrap gap-4 mb-8`}>
        <div className="w-full md:w-auto">
          ...
          <select
            className="border rounded px-3 py-2 bg-white text-gray-800 disabled:bg-gray-100 disabled:text-gray-500"
            value={period}
