      ...
      <Accordion type="single" collapsible className="mb-4">
          ...
          <AccordionContent>
            <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative group">
                <Label htmlFor="academyName" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Academy Name</Label>
              ...
              <div className="relative group">
                <Label htmlFor="branch" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Branch</Label>
              ...
              <div className="relative group col-span-2">
                <Label htmlFor="roiType" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>ROI Type</Label>
        ...
        <AccordionItem value="step2">
          ...
          <AccordionContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative group">
                <Label htmlFor="initialInvestment" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Initial Investment</Label>
              ...
              <div className="relative group">
                <Label htmlFor="ongoingCost" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Ongoing Cost</Label>
              ...
              <div className="relative group flex flex-col">
                <Label htmlFor="startDate" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Start Date</Label>
                ...
                <Label htmlFor="endDate" className="text-sm mb-1 mt-2" style={{ color: `${primaryColor}dd` }}>End Date</Label>
              ...
              <div className="relative group">
                <Label htmlFor="instructorSalaries" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Instructor Salaries</Label>
              ...
              <div className="relative group">
                <Label htmlFor="marketingSpend" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Marketing Spend</Label>
              ...
              <div className="relative group">
                <Label htmlFor="equipmentCost" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Equipment/Facility Cost</Label>
              ...
              <div className="relative group">
                <Label htmlFor="maintenance" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Maintenance/Overheads</Label>
              ...
              <div className="relative group">
                <Label htmlFor="loanRepayments" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Loan Repayments</Label>
        ...
        <AccordionItem value="step3">
          ...
          <AccordionContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative group">
                <Label htmlFor="enrollments" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Enrollments</Label>
              ...
              <div className="relative group">
                <Label htmlFor="pricePerEnrollment" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Price per Enrollment</Label>
              ...
              <div className="relative group">
                <Label htmlFor="totalIncome" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Total Income</Label>
              ...
              <div className="relative group">
                <Label htmlFor="upsellRevenue" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Upsell Revenue</Label>
              ...
              <div className="relative group">
                <Label htmlFor="paymentIncome" className="text-sm mb-1" style={{ color: `${primaryColor}dd` }}>Income from Payments</Label>
      ...
      {showResult && (
        <Fragment>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            <Card className="bg-white" style={{ border: `1px solid ${secondaryColor}33` }}>
              <CardHeader>
                <CardTitle className="text-lg" style={{ color: primaryColor }}>ROI %</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold" style={{ color: primaryColor }}>{roi.toFixed(2)}%</div>
                <div className="text-xs text-gray-500 dark:text-white mt-1">Annualized: {annualROI.toFixed(2)}%</div>
              </CardContent>
            </Card>
            <Card className="bg-white" style={{ border: `1px solid ${secondaryColor}33` }}>
              <CardHeader>
                <CardTitle className="text-lg" style={{ color: primaryColor }}>Total Profit / Loss</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-white" style={{ border: `1px solid ${secondaryColor}33` }}>
              <CardHeader>
                <CardTitle className="text-lg" style={{ color: primaryColor }}>Payback Duration</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold" style={{ color: primaryColor }}>{showPayback ? `${paybackMonths!.toFixed(1)} months (${paybackYears?.toFixed(2)} yrs)` : "N/A"}</div>
              </CardContent>
            </Card>
            <Card className="bg-white" style={{ border: `1px solid ${secondaryColor}33` }}>
              <CardHeader>
                <CardTitle className="text-lg" style={{ color: primaryColor }}>Breakeven Status</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-white" style={{ border: `1px solid ${secondaryColor}33` }}>
              <CardHeader>
                <CardTitle className="text-lg" style={{ color: primaryColor }}>Breakeven Enrollments</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold" style={{ color: primaryColor }}>{showBreakevenEnrollments ? breakevenEnrollments!.toFixed(0) : "N/A"}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Card className="bg-white" style={{ border: `1px solid ${secondaryColor}33` }}>
              <CardHeader>
                <CardTitle className="text-base" style={{ color: primaryColor }}>ROI Over Time</CardTitle>
              </CardHeader>
              <CardContent className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={roiOverTime}>
                    ...
                    <RechartsTooltip />
                    <Legend />
                    <Line type="monotone" dataKey="roi" stroke={primaryColor} />
                  </LineChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            <Card className="bg-white" style={{ border: `1px solid ${secondaryColor}33` }}>
              <CardHeader>
                <CardTitle className="text-base" style={{ color: primaryColor }}>Revenue vs Cost</CardTitle>
              </CardHeader>
              <CardContent className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={revenueVsCost}>
                    ...
                    <RechartsTooltip />
                    <Legend />
                    <Bar dataKey="value" fill={secondaryColor} />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            <Card className="bg-white" style={{ border: `1px solid ${secondaryColor}33` }}>
              <CardHeader>
                <CardTitle className="text-base" style={{ color: primaryColor }}>Cost Breakdown</CardTitle>
              </CardHeader>
              <CardContent className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
          ...
          <div className="rounded-xl p-6 mb-6" style={{ background: `color-mix(in oklab, ${secondaryColor} 10%, white)`, border: `1px solid ${secondaryColor}33` }}>
            <h3 className="text-lg font-bold mb-2" style={{ color: primaryColor }}>AI-generated Insights</h3>
            <ul className="list-disc ml-6" style={{ color: primaryColor }}>
