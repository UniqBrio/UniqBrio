            ...
            <form onSubmit={handleIncomeSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <DropdownMenu open={categoryDropdownOpen} onOpenChange={setCategoryDropdownOpen}>
                    <DropdownMenuTrigger asChild>
                      <Button 
                        variant="outline" 
                        className="w-full h-10 text-left justify-between border-gray-300 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-current focus:border-transparent" 
                        tabIndex={3}
                        onKeyDown={(e) => {
                    ...
                    <DropdownMenuContent className="w-64 p-2 text-[15px]">
                      <div className="mb-2" onClick={e => e.stopPropagation()}>
                        <Input placeholder="Search or type new category..." className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-current" value={categorySearchTerm} onChange={e => setCategorySearchTerm(e.target.value)} onKeyDown={e => e.stopPropagation()} />
                      </div>
                ...
                <div className="space-y-2">
                  ...
                  <DropdownMenu open={sourceDropdownOpen} onOpenChange={setSourceDropdownOpen}>
                    ...
                    <DropdownMenuContent className="w-64 p-2 text-[15px]">
                      <div className="mb-2" onClick={e => e.stopPropagation()}>
                        <Input placeholder="Search or type new source..." className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-current" value={sourceSearchTerm} onChange={e => setSourceSearchTerm(e.target.value)} onKeyDown={e => e.stopPropagation()} />
                      </div>
                      <div className="max-h-[200px] overflow-y-auto">
                        {(options.incomeSources || [])
                          .filter((source: string) => source.toLowerCase().includes(sourceSearchTerm.toLowerCase()))
                ...
                <div className="space-y-2">
                  ...
                  <Select value={incomeForm.paymentMode} onValueChange={v => handleIncomeChange('paymentMode', v)}>
                    <SelectTrigger className="w-full h-10 border-gray-300 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-current focus:border-transparent" tabIndex={5}>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className={`w-full h-10 border-gray-300 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-current focus:border-transparent ${incomeForm.paymentMode?.toLowerCase() === 'cash' ? 'opacity-50 cursor-not-allowed' : ''}`} tabIndex={6}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    className="flex h-10 w-full rounded-md border border-gray-300 dark:border-gray-600 bg-background dark:bg-gray-800 px-3 py-2 text-sm text-foreground placeholder:text-gray-400 dark:text-white dark:placeholder:text-gray-500 dark:text-white focus:outline-none focus:ring-2 focus:ring-current focus:border-transparent" 
                ...
                {draftId ? (
                  <>
                    <Button
                      ...
                      className="h-10 px-4 text-white border-0 primary-btn border-0"
                      tabIndex={12}
                    >
                      ...
                      <TooltipTrigger asChild>
                        <span tabIndex={-1}>
                          <Button 
                            ...
                            className="h-10 px-6 text-white border-0 primary-btn disabled:opacity-50 disabled:cursor-not-allowed"
                            tabIndex={13}
                          >
                            Add Income
                          </Button>
