...
export const ColumnSelectorModal: React.FC<ColumnSelectorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg shadow-xl p-8 min-w-[500px] max-w-[95vw] relative z-[10000]">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex flex-col justify-center gap-2">
            ...
            <button
              className={`px-3 py-1 rounded flex items-center justify-center transition-colors ${draftDisplayed.length === 0 || draftDisplayed.length === requiredColumns.length ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-purple-100 text-purple-700 hover:bg-purple-200'}`}
                  ...
                  <label
                    ...
                    className={`flex items-center gap-2 py-1 rounded px-2 ${
                      isRequired 
                        ...
                        : `cursor-pointer ${focusedList === 'displayed' && focusedIndex === idx ? 'bg-purple-100 border border-purple-300' : 'hover:bg-gray-50'}`
                    }`}
                    onClick={() => { 
                      if (!isRequired) {
                        setFocusedList('displayed'); 
