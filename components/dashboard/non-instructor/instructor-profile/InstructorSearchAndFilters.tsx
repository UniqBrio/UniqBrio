  ...
  return (
    <div className="flex justify-between items-center mb-4">
        <div className="flex items-center gap-4">
          <h1 className="text-lg font-semibold text-gray-900 dark:text-white">List of Non-Instructors</h1>
          <div className="relative">
            <Search className="absolute left-2 top-2.5 h-3.5 w-3.5 text-gray-400 dark:text-white" />
            <Input
              placeholder="Search non-instructors..."
        ...
        <div className="flex flex-wrap gap-2">
          <input
            ...
            onChange={async (e) => {
              ...
              if (file.name.endsWith('.csv')) {
                ...
                reader.onload = async (e) => {
                  ...
                  for (let i = 1; i < lines.length; i++) {
                    ...
                    const instructor: Instructor = {
                      id: values[findIdx(['Non-Instructor ID','ID'])] || `NON INS${String(Date.now()).slice(-6)}`,
                ...
                toast({ title: 'Not implemented', description: 'Excel import not yet implemented for non-instructors.' })
              } else {
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              // Define export columns for non-instructors (includes all mandatory fields from add form)
              const exportColumns = [
                { header: 'Non-Instructor ID', key: 'id' },
                { header: 'Non Instructor Name', key: 'name' },
              ...
              dlAnchor.setAttribute("download", `non_instructors_export_${date}.csv`);
