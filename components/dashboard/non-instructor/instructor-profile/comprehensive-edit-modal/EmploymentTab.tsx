    ...
    <div className="space-y-6 opacity-50 pointer-events-none select-none">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input id="loginUsername" value={editForm.email} disabled className="bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-white" placeholder="Auto-generated from email" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="temporaryPassword">Temporary Password</Label>
          <Input id="temporaryPassword" value={editForm.temporaryPassword || ""} disabled className="bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-white" placeholder="Auto-generated, will be emailed" />
        </div>
