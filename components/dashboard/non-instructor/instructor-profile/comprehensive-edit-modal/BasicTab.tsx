      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            />
            {!dobFocused && (
              <div className={`absolute inset-0 flex items-center px-3 text-sm pointer-events-none ${editForm.dob ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-white'} z-0`}>
