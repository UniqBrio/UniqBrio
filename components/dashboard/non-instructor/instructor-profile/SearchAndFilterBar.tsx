...
export default function SearchAndFilterBar({
  ...
  // When the permanent filter icon is set (apply/clear), briefly show the tooltip
  // and auto-hide it after 3 seconds. Keep the permanent icon itself unchanged.
  useEffect(() => {
    ...
    return () => {
      // No-op on every change; cleanup happens in unmount effect below
    }
  }, [permanentFilterIcon])
    ...
    <div className="px-6 pb-4">
        ...
        <div className="flex gap-2">
          ...
          <Popover open={filterDropdownOpen} onOpenChange={setFilterDropdownOpen}>
            ...
            <PopoverContent className="w-80 p-4 filter-panel">
              ...
              {/* Course Filter removed for Non-Instructor table */}
                  ...
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline" size="sm" className="h-9 flex items-center gap-1">
                      <span className="text-xs flex items-center gap-1">
                        ...
                        {sortBy === "contractType" && "Contract Type"}
                        {sortBy === "jobLevel" && "Job Level"}
                        {sortOrder === "asc" ? (
                ...
                {[ 
                  ...
                  <DropdownMenuItem
                    ...
                    onClick={() => {
                      ...
                      // Auto-hide the sort tooltip after 3 seconds
          ...
          {onOpenAddDialog && (
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent side="bottom">Add new non-instructor</TooltipContent>
              </Tooltip>
            </TooltipProvider>
          )}
        </div>
      ...
      <div className="text-sm mb-2 flex items-center justify-between w-full">
        <div className="flex items-center gap-2 text-[#7C3AED]">
          ...
          <span>
            Showing <span className="font-semibold">{filteredInstructors.length}</span> non-instructors
          </span>
        </div>
        {viewMode === 'list' && (
          <span
