...
const EXPECTED_COLUMNS = [
  {
    name: "ID",
  description: "Unique non-instructor identifier (e.g., NON INS0001)",
    required: true,
  examples: ["NON INS0001", "EMP001", "STAFF123"]
  },
  {
    name: "Name", 
  description: "Full name of the non-instructor",
    required: true,
...
NON INS0001,Mr. John Smith,Senior Staff,Permanent,Casual Leave,Personal leave,2025-10-04,2025-10-04,2025-10-04,APPROVED,1,15
NON INS0002,Ms. Jane Doe,Junior Staff,Permanent,Sick Leave,Medical appointment,2025-10-05,2025-10-07,2025-10-05,APPROVED,3,12`
