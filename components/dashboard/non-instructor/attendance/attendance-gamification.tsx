  ...
  return (
    <div className="space-y-6 ">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold">Attendance Gamification </h2>
      ...
      <Tabs defaultValue="badges" className="space-y-4">
        ...
        <TabsContent value="badges" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Instructor Progress</CardTitle>
                  ...
                  <div className="flex justify-center space-x-4 mb-6">
                    ...
                    <div className="flex flex-col items-center order-1 mt-4">
                      ...
                      <div className="text-center">
                        ...
                        <Badge className="mt-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-white">2nd Place</Badge>
                      </div>
                    </div>
