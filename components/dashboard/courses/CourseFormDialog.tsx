...
export default function CourseFormDialog({
  ...
  courseId: newCourseForm.id,
        ...
        prerequisites: Array.isArray(newCourseForm.prerequisites) ? newCourseForm.prerequisites : [],
        learningOutcomes: Array.isArray(newCourseForm.learningOutcomes) ? newCourseForm.learningOutcomes : ['Complete understanding of the subject'],
