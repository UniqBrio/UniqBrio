...
export default function MarketingTab({ formData, onFormChange }: MarketingTabProps) {
  ...
  <div className="mb-2 p-2 bg-blue-50 border border-blue-200 rounded-lg">
      ...
      <div className="space-y-2">
        <h4 className="font-medium text-sm">Promotion Templates</h4>

        <div className="space-y-2">
          <div>
            <Label htmlFor="promoTemplate" className="mb-1 text-xs">Template Message</Label>
            <Textarea
              id="promoTemplate"
          ...
          <div>
            <Label htmlFor="promoChannels" className="mb-1 text-xs">Marketing Channels</Label>
            <div className="flex gap-2 mt-1">
              <div className="flex items-center space-x-1 text-xs">
                ...
                />
                <Label htmlFor="emailChannel" className="text-xs">Email</Label>
              </div>
              <div className="flex items-center space-x-1 text-xs">
                <Checkbox 
                  id="socialChannel" 
                ...
                />
                <Label htmlFor="socialChannel" className="text-xs">Social Media</Label>
              </div>
              <div className="flex items-center space-x-1 text-xs">
                <Checkbox 
                  id="websiteChannel" 
                ...
                />
                <Label htmlFor="websiteChannel" className="text-xs">Website</Label>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-2">
        <h4 className="font-medium text-sm">Seasonal Promotions</h4>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div>
            <Label htmlFor="promoName" className="mb-1 text-xs">Promotion Name</Label>
            <Input 
              id="promoName" 
          ...
          <div>
            <Label htmlFor="discountPercent" className="mb-1 text-xs">Discount Percentage</Label>
            <Input 
              id="discountPercent" 
              placeholder="25" 
              type="number" 
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div>
            <Label htmlFor="promoStart" className="mb-1 text-xs">Start Date</Label>
            <Input 
              id="promoStart" 
              type="date"
              className="text-sm px-2 py-1"
          ...
          <div>
            <Label htmlFor="promoEnd" className="mb-1 text-xs">End Date</Label>
            <Input 
              id="promoEnd" 
              type="date"
              className="text-sm px-2 py-1"
        ...
        <div>
          <Label htmlFor="promoConditions" className="mb-1 text-xs">Conditions</Label>
          <Textarea
            id="promoConditions"
