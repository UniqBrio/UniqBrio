...
export function AttendanceSettings() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold inline-flex items-center gap-2">Notification Settings <Image src="/Coming soon.svg" alt="Coming Soon" width={16} height={16} className="inline-block" /></h2>
              ...
              <div className="pt-4 border-t">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="notify-instructor">Instructors</Label>
                  </div>
                  <div className="flex items-center space-x-2">
