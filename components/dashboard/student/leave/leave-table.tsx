      ...
      case 'Course Details':
        return (
          <div className="space-y-1">
            ...
            <div className="text-xs text-gray-500 truncate" title={row.courseId}>{row.courseId || '-'}</div>
          </div>
        );
      case 'Cohort Details':
        return (
          <div className="space-y-1">
            ...
            <div className="text-xs text-gray-400 truncate" title={row.cohortTiming}>{row.cohortTiming || '-'}</div>
          </div>
        );
      case 'Date':
