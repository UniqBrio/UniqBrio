...
export const ColumnSelectorModal: React.FC<ColumnSelectorModalProps> = ({
  ...
  <div className="bg-white rounded-lg shadow-xl p-8 min-w-[500px] max-w-[95vw] max-h-[85vh] overflow-hidden flex flex-col">
        <div className="font-bold text-lg mb-4">Select Columns to Display</div>
        
        <div className="text-sm text-gray-600 mb-3 p-3 bg-purple-50 rounded-lg border border-purple-200 flex-shrink-0">
