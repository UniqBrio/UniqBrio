    ...
    <div className="w-full space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {topStats.map((stat, index) => {
          ...
          return (
            <div key={index} className={`${style.bg} border rounded-xl p-4 cursor-pointer transition-all hover:shadow-lg`}>
              <div className="flex items-center justify-between">
                <div>
                  <p className={`text-sm font-medium ${style.titleText}`}>{stat.title}</p>
                  <p className={`text-2xl font-bold ${style.valueText} mt-2`}>{stat.value}</p>
                  <p className={`text-xs ${style.titleText} opacity-80 mt-1`}>{stat.subtitle}</p>
                </div>
              </div>
            </div>
          )
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={revenueByEvent}>
                  ...
                  <XAxis 
                    ...
                    height={80}
                    style={{ fontSize: '12px' }}
                    label={{ value: 'Event Name', position: 'insideBottom', offset: -5 }}
                  />
                  <YAxis 
        ...
        <>
          ...
          <TabsContent value="events">
                  <div className="bg-card rounded-3xl shadow-xl p-6 animate-fade-in border">
                    ...
                    <div className="sticky top-0 z-20 bg-card pt-0 pb-4">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        <div className="relative flex-1 min-w-[250px]">
                          ...
                          <input
                            type="text"
                            placeholder="Search events, sports, staff..."
                            value={searchTerm}
                        ...
                        >
                          ...
                          {selectedOngoingIds.length ? `Export (${selectedOngoingIds.length})` : 'Export'}
                        </Button>
                ...
                <TabsContent value="upcoming">
                  <div className="bg-card rounded-3xl shadow-xl p-6 animate-fade-in border">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        >
                          <Download className="h-4 w-4 mr-2" />
                          {selectedUpcomingIds.length ? `Export (${selectedUpcomingIds.length})` : 'Export'}
                        </Button>
                ...
                <TabsContent value="completed">
                  <div className="bg-card rounded-3xl shadow-xl p-6 animate-fade-in border">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        >
                          <Download className="h-4 w-4 mr-2" />
                          {selectedCompletedIds.length ? `Export (${selectedCompletedIds.length})` : 'Export'}
                        </Button>
