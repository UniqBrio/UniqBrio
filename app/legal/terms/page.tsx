        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 md:p-10 mb-8">
          ...
          <div className="mb-6 p-6 bg-gray-50 rounded-2xl border border-gray-200 hover:border-purple-300 hover:shadow-md transition-all">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold text-gray-900 mb-3">2. Your account</h2>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Keep your password safe. You are responsible for everything that happens under your account.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">One academy = one administrator account (free or paid). Creating fake accounts is not allowed.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mb-6 p-6 bg-green-50 rounded-2xl border border-green-200">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold text-gray-900 mb-3">3. What you can do</h2>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Use UniqBrio to manage classes, students, payments, attendance, and communication.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Invite staff, students, and parents – they'll each get their own secure login.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mb-6 p-6 bg-red-50 rounded-2xl border border-red-200">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold text-gray-900 mb-3">4. What you cannot do</h2>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <XCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Share, sell, or reverse-engineer UniqBrio.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <XCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Upload anything harmful (viruses, hate speech, illegal content).</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <XCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Use the platform for anything except running your legitimate arts/sports academy.</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Free tier: genuinely useful forever for small academies.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-purple-600 font-bold mt-0.5">•</span>
                    <span className="text-gray-700">Paid plans: monthly or yearly, auto-renew. Cancel anytime from Settings → Billing.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-purple-600 font-bold mt-0.5">•</span>
                    <span className="text-gray-700">All fees are in Indian Rupees (INR) and non-refundable except where required by law.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-purple-600 font-bold mt-0.5">•</span>
                    <span className="text-gray-700">Late payments may temporarily limit access until settled.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mb-6 p-6 bg-gray-50 rounded-2xl border border-gray-200 hover:border-purple-300 hover:shadow-md transition-all">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold text-gray-900 mb-3">6. Content & Data</h2>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">You own your data (student names, photos you upload, schedules, etc.).</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">You give us permission to store, process, and display it so the platform works.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">We'll never sell your academy's data.</span>
                  </li>
                </ul>
              </div>
            </div>
